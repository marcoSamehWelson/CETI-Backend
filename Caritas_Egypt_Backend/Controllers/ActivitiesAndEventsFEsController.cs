...
namespace Caritas_Egypt_Backend.Controllers
{
    public class ActivitiesAndEventsFEsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Tittle,Descreption,img")] ActivitiesAndEventsFE activitiesAndEventsFE)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Tittle,Descreption,img")] ActivitiesAndEventsFE activitiesAndEventsFE)
        {
