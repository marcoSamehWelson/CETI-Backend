...
namespace Caritas_Egypt_Backend.Controllers
{
    public class ProgramsCategoryFEsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Tittle,Descreption,img,serial")] ProgramsCategoryFE programsCategoryFE)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Tittle,Descreption,img,serial")] ProgramsCategoryFE programsCategoryFE)
        {
