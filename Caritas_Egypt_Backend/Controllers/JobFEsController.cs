...
namespace Caritas_Egypt_Backend.Controllers
{
    public class JobFEsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Tittle,Descreption,img")] JobFE jobFE)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Tittle,Descreption,img")] JobFE jobFE)
        {
            if (id != jobFE.Id)
            {
                return NotFound();
