...
namespace Caritas_Egypt_Backend.Controllers
{
    public class ProjectsCategoryFEsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Tittle,Descreption,img")] ProjectsCategoryFE projectsCategoryFE)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Tittle,Descreption,img")] ProjectsCategoryFE projectsCategoryFE)
        {
